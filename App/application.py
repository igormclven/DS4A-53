...
sidebar_section = html.Div([
    html.Div(children  = [
        ...
        html.Div([
            ...
            html.P("Please enter the following data based on 'Important Macroeconomic Indicators' Tab:", className="lead"),
        ],className='p-3'),        
                    ...
                    html.Div(className='row',children = [
                        html.Div(className='col',children = [
                            html.Div(className='card border-warning animate__animated animate__bounceIn',children = [
                                html.Img(src="assets/oscar_1.png", className='mx-auto d-block p-3', width='300'),
                                html.Div([
                        ...
                        html.Div(className='col',children = [
                            html.Div(className='card border-info animate__animated animate__bounceIn',children = [
                                html.Img(src="assets/mauricio.jfif", className='mx-auto d-block p-3', width='300'),
                                html.Div([
                ...
                dcc.Tab(id='predictionsTab',label='Predictions',value="tab-4", children=[
                    ...
                    html.Div(className='card',children = [
                        html.Div([
                            ...
                            html.H4("Our recommendation for IPVU Medellin is 2255.9505"),
                            html.H4("Our recommmendation for Occupancy Rate is 53.357325"),
                            html.H4("Our recommendation for TRM Change is 3,656"),
...
def update_children(n, ipvu, er,tc):
    ...
    figure= px.line(predictions_df,x='Año',y='recaudo',
            labels ={'Año' : 'Year','recaudo':'Property Tax Total'},template = 'plotly').add_annotation(text= 'Your prediction for '+str(next_year),x=next_year,y=prediction,arrowhead=3,showarrow=True,arrowcolor='black')
